            ...
            <div className="wrapper bg-black text-white p-3 xs:px-5 sm:px-5 md:px-16 lg:px-24 py-5 relative">
                ...
                <main>
                    ...
                    <section className='flex flex-col text-center py-5 gap-5 md:py-20 md:gap-20'>
                        <video className='absolute opacity-20 left-0 top-0 w-[100%] h-[100vh] object-cover'
                               src={heroVid} autoPlay={true} muted loop></video>
                        ...
                        <div className='overflow-hidden flex flex-col  gap-20 relative z-50'>
                            <motion.h1
                                ...
                                <br/>
                                <motion.span className='inline-block' variants={childVariants}>Experiences.
                                </motion.span>
                            </motion.h1>
                            <div
                                className='hero-cards flex md:gap-0 md:flex-row flex-col gap-6  justify-evenly items-center text-lg'>
                                <motion.div
                                    initial={{
                                        x: -50,
                                        opacity: 0,
                                ...
                                <motion.div
                                    ...
                                    <h3 className='my-2'><span className='text-green-600'>85%</span> Client <br/>Satisfaction
                                    </h3>
                                </motion.div>
                        ...
                        <div className='ouss-about-content flex xl:flex-row gap-6 flex-col justify-around items-center'>
                            <motion.div
                                ...
                                <div className='flex flex-col gap-4'>
                                    <h1 className='uppercase font-karantina text-8xl text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-white to-white'> I'm
                                        Aichaoui Oussama </h1>
                                    <hr/>
                                </div>
                                ...
                                <p className='text-xl font-bigshoulderstext text-justify'>I’m 27 years old, based in
                                    Algiers, Algeria, and have
                                    <span className='text-blue-500'> over 7 years of experience </span>
                                    in the software development industry. My curiosity has always been driven by a
                                    desire to understand how things work, a passion I developed from childhood. </p>
                                <p className='text-xl font-bigshoulderstext text-justify'>
                                    Throughout my career, I have specialized in creating seamless, high-performance
                                    applications. My expertise spans both front-end and back-end development, allowing
                                    me to design and implement efficient systems and build intuitive, user-friendly
                                    interfaces.
                                </p>
                                <p className='text-xl font-bigshoulderstext text-justify'>
                                    I am committed to clean, maintainable code and user-centric design, ensuring that
                                    each project I work on meets both technical and user requirements. My continuous
                                    desire to learn keeps me updated with the latest technologies and development
                                    practices, and I’m always looking for opportunities to grow professionally.
                                </p>
                            </motion.div>
                            <motion.div
                                initial={{
                    ...
                    <OussSection direction='v' title='projects' className='gap-5'>
                      ...
                      <OussProject
                          company='Tech For Startups.'
                          position='Bakend Engineer'
                          employment='hybrid'
                          from={new Date('2025-05-14')}
                          ...
                          descParagraphs={
                            [
                                "Hirinii is a modern recruitment platform developed to streamline how candidates and recruiters connect, with a focus on verified professional identities and enhanced discoverability. Designed specifically for the Algerian market, Hirinii introduces a practical, localized solution to hiring challenges.",


                                "Candidates can register, build a professional profile, and optionally verify their identity and academic credentials. They can manage their CVs, saving them as drafts or publishing them to be visible in recruiter search results. Recruiters can then explore available talent through a clean, user-friendly search interface.",

                                "My role in this project was to develop the application from scratch, architecting and implementing the backend using the NestJS ecosystem. I was responsible for integrating external services such as payment gateways and ChatGPT APIs, building out the RESTful API that powers the frontend, and ensuring it was fully documented for maintainability and team collaboration. I also implemented CI/CD pipelines to automate testing, building, and deployment processes, ensuring faster and more reliable delivery.",
                                "Although the frontend was handled by another developer, I collaborated closely to support integration and ensure smooth end-to-end functionality.",
                                "The project has shown strong early traction and is positioned as a promising innovation in the Algerian recruitment landscape.",
                            ]

                          }
                          techs={[ 'nestJS','postgres', 'api', 'docker', 'github' , 'githubActions']}
                      />
                    ...
                    <OussSection direction='h' title='services'
                                 className='flex flex-row gap-20 flex-wrap justify-center xl:justify-between py-10'>

                        <OussService imgIndex={1} icon={webIcon} title='web application development'
                                     content='Crafting modern, responsive, and high-performance web applications tailored to your needs.'/>
                        <OussService imgIndex={2} icon={frontendIcon} title='Front-End Development'
                                     content='Building intuitive and visually appealing user interfaces using the latest frameworks and technologies.'/>
                        <OussService imgIndex={3} icon={backendIcon} title='Back-End Development'
                                     content='Developing robust, secure, and scalable server-side solutions to power your applications.'/>
                        <OussService imgIndex={4} icon={apiIcon} title='API Development'
                                     content='Creating RESTful and GraphQL APIs for seamless integration with third-party services and systems.'/>
                        <OussService imgIndex={5} icon={mobileIcon} title='Mobile Application Development'
                                     content='Delivering cross-platform mobile applications with sleek designs and smooth functionality using frameworks like Flutter or React Native.'/>
                        <OussService imgIndex={6} icon={graphicIcon} title='Graphic Designer & Video Editor'
                                     content='creating reels, posters, logos, and short videos and more in order to bring creative ideas to life and engage your audience.'/>
                    ...
                    <OussSection direction='v' title='contact'>
                        ...
                        <div
                            className=' bg-gradient-to-b from-[#FFFFFF] to-[#999999] rounded-3xl px-8 py-10 text-black font-productsans flex flex-col gap-6'>
                            <div className='footer-header text-5xl leading-normal'>
                                Got Ideas? We have <span
                                className='relative after:absolute after:left-0 after:bottom-0 after:w-full after:z-[0] after:h-[25%] z-[99] after:bg-green-500 after:mix-blend-hue'>The solution,</span>
                                ...
                                <div className='flex flex-col gap-4 md:flex-row justify-around items-center'>
                                    ...
                                    <div className='flex justify-end flex-1 gap-6'>
                                        <a href="https://www.linkedin.com/in/oussama-aichaoui/">
                                            <img className='hover:scale-110 transition-all duration-150 cursor-pointer'
                                                 src={linkedinIcon} alt="" width={40}/>
                                        </a>
                                        <a href="">
                                            <img className='hover:scale-110 transition-all duration-150 cursor-pointer'
                                                 src={fiverrIcon} alt="" width={40}/>
                                        </a>
                                        <a href="mailto:ouss.aich2022@gmail.com">
                                            <img className='hover:scale-110 transition-all duration-150 cursor-pointer'
                                                 src={gmailIcon} alt="" width={40}/>
                                        </a>
                                        <a href="https://wa.me/213792333216">
                                            <img className='hover:scale-110 transition-all duration-150 cursor-pointer'
                                                 src={whatsappIcon} alt="" width={40}/>
                                        </a>
                                        <a href="https://t.me/+213792333216">
                                            <img className='hover:scale-110 transition-all duration-150 cursor-pointer'
                                                 src={telegramIcon} alt="" width={40}/>
                                        </a>
                                        <a href="https://github.com/ouss2022aich">
                                            <img className='hover:scale-110 transition-all duration-150 cursor-pointer'
                                                 src={githubIcon} alt="" width={40}/>
                                        </a>
                                        <a href="https://discord.com/users/694931992382537760">
                                            <img className='hover:scale-110 transition-all duration-150 cursor-pointer'
                                                 src={discordIcon} alt="" width={40}/>
                                        </a>
                                    </div>
